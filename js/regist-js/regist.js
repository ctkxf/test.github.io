$.getScript("./js/regist-js/popovers.js");
$.getScript("./js/regist-js/yzm.js");
$.getScript("./js/regist-js/question-answer.js");
$.getScript("./js/regist-js/validator.js");
$.getScript("./js/regist-js/dateTime.js");
$.getScript("./js/regist-js/password.js");
 ...
 */
    ...
    $("#yzm").text(random());//设置验证码在界面加载时的第一次随机。
